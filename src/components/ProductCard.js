  ...
  return (
    ...
    >
      {pathname.includes("cart") && (
        <div className="bg-indigo-500 text-white grid place-items-center rounded-full absolute top-2 right-2 h-8 w-8">
      ...
      <div className="flex gap-2 mt-5">
        ...
        {pathname.includes("cart") && (
          <button
            className="bg-red-500 flex justify-between w-full items-center rounded-full py-1 px-10 text-white text-bold"
